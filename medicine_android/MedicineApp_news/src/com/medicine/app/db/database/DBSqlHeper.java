...
public class DBSqlHeper extends SQLiteOpenHelper implements CommonConst{
	...
	private static final String CREATE_KNOWLEDGE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + KnowledgeBean.TABLE_NAME + "(id INTEGER PRIMARY KEY AUTOINCREMENT,"+KnowledgeBean.ID+" TEXT, "+KnowledgeBean.DATA_TIME+" TEXT, "+KnowledgeBean.HEADSTR+" TEXT, "+KnowledgeBean.CONTENT_M+" TEXT, "+KnowledgeBean.CONTENT+" TEXT)";
